...
const char* Usuario::getApellido() const { return apellido; }
const char* Usuario::getTelefono() const { return telefono; }
const char* Usuario::getEmail() const { return email; }
bool Usuario::getEstado() const { return estado; }

// ======= SETTERS =======

void Usuario::setID(int valor) { id = valor; }
...
void Usuario::setEstado(bool valor) { estado = valor; }
